//! A lightweight "symbolic notation" renderer: converts common LaTeX /
//! TeX math and symbol commands found in pi messages into Unicode so they
//! display correctly in the Markdown viewer (iced's markdown widget has no
//! native LaTeX support, but tables are handled by pulldown-cmark directly).
//!
//! This is intentionally a best-effort approximation covering the symbols
//! that most often appear in assistant replies. Markdown itself is left
//! untouched so tables, code blocks and emphasis still render.
...
fn symbols() -> HashMap<&'static str, &'static str> {
    [
        ...
        ("because", "∵"), ("angle", "∠"), ("triangle", "△"),
        ("triangleq", "≜"), ("cong", "≅"), ("simeq", "≃"),
        ("degree", "°"), ("prime", "′"), ("ldots", "…"), ("cdots", "⋯"),
        ("dots", "…"), ("ldots", "…"), ("hbar", "ℏ"), ("ell", "ℓ"),
        ("Re", "ℜ"), ("Im", "ℑ"), ("aleph", "ℵ"), ("eth", "ð"),
        ("mho", "℧"), ("wp", "℘"), ("pounds", "£"), ("euro", "€"),
        ("text", ""), ("mathrm", ""), ("mathbf", ""), ("mathit", ""),
        ("textrm", ""), ("operatorname", ""), ("displaystyle", ""),
        ("left", ""), ("right", ""), ("big", ""), ("Big", ""),
        ("bigg", ""), ("Bigg", ""), ("limits", ""), ("nolimits", ""),
        ("quad", "  "), ("qquad", "    "), (",", " "), (";", " "),
        ("!", ""), (":", " "), (" ", " "),
    ]
    .into_iter()
...
mod tests {
    ...
    fn converts_latex_symbols() {
        assert_eq!(to_unicode("$\\alpha^2 + \\beta$"), "α² + β");
        assert_eq!(to_unicode("\\to \\Rightarrow"), "→ ⇒");
        assert_eq!(to_unicode("x \\in \\mathbb{R}"), "x ∈ ℝ");
        assert_eq!(to_unicode("\\sum_{i=1}^{n} i"), "∑ᵢ₌₁ⁿ i");
        assert_eq!(to_unicode("\\sqrt{x} \\neq 0"), "√x ≠ 0");
        assert_eq!(to_unicode("a \\leq b \\land c"), "a ≤ b ∧ c");
        assert_eq!(to_unicode("\\pi \\approx 3.14"), "π ≈ 3.14");
    }

    #[test]
    fn leaves_markdown_tables_intact() {
        let md = "| a | b |\n|---|---|\n| 1 | 2 |";
        assert_eq!(to_unicode(md), md);
    }
}
